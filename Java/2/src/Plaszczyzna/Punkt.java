...
public class Punkt {
    ...
    public void odbij(Prosta p) {
        ...
        x=(p.a*(d-y))/p.b + x; // błąd z prawdopodobnym 0 w mianowniku
        y=d;
    }
    ...
    public void obroc(Punkt p, double kat) {
        ...
        // Przesunięcie wykresu do pkt p, obliczamy przesunięcie sinusem i cosinusem

    }

    public static boolean rozne(Punkt a, Punkt b){
