...
class Store(object):
    ...
    def add_to_offer(self, product_name, description, price):
        ...
        if product_name in self.offer:
            raise ProductAlreadyExists("Product '{}' is already in the store's offer.".format(product_name))
        self.offer[product_name] = {
    ...
    def delete_from_offer(self, product_name):
        ...
        try:
            ...
            raise ProductNotFound("Product '{}' is not in the store's offer.".format(product_name))
...
class Cart(object):
    ...
    def set_quantity(self, product_name, quantity):
        if product_name in self.products:
            ...
            raise ProductNotFound("Product '{}' is not in the shopping cart.".format(product_name))

    def get_total(self):
        return sum(self.store.offer[product_name]['price'] * quantity
    ...
    def show(self):
        ...
        print('Shopping cart:')
        print(tabulate([(product_name, self.store.offer[product_name]['price'], quantity)
                        for product_name, quantity in self.products.items()],
